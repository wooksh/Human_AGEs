...
var RBush = /** @class */ (function () {
    ...
    RBush.prototype.getInExtent = function (extent, featureAvailabilityDict = {}) {
        ...
        for(var i = 0; i < items.length; ++i) {
            ...
            if( !(getUid(feature) in featureAvailabilityDict) )
    ...
    RBush.prototype.getInExtentForClustering = function (extent, 
        clustered, positionInfo, geometryCache, theCluster, featureRegionId, isClusteringByRegion) {
        ...
        for(var i = 0; i < items.length; ++i) {
            ...
            if( !(featureUid in clustered) ) {
                ...
                if(!(featureUid in geometryCache))
                    geometryCache[featureUid] = theCluster.geometryFunction(feature);
                ...
                if(isNotFiltered) {
                    ...
                    if( isClusteringByRegion ) {
                        ...
                        if( isValidNonEmpty && isNeighborValidNonEmpty ) {
                            ...
                            if( featureRegionName !== neighborRegionName )
                                isNotFiltered = false;
                        } else {
                            isNotFiltered = false;

                            if(!isNeighborValidNonEmpty)
