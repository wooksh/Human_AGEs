...
<div id="{{= it.group_id }}" class="rules-group-container"> \
  <div class="rules-group-header"> \
    <div class="btn-group pull-right group-actions"> \
      ...
      {{?}} \
      {{? it.level>1 }} \
        <button type="button" class="btn-xs btn custom-button mb-0 palette-tertiary-light no-focus negative" data-delete="group"> \
...
<div id="{{= it.rule_id }}" class="rule-container"> \
  <div class="rule-header"> \
    <div class="btn-group pull-right rule-actions"> \
      <button type="button" class="btn-xs btn custom-button mb-0 palette-tertiary-light no-focus negative" data-delete="rule"> \
