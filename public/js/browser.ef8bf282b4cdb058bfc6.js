...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;pug_html = pug_html + "\u003Cscript defer type=\"text\u002Fjavascript\" src=\"\u002Fjs\u002Ffaq.08dbf339b2cdc3d48d85.js\"\u003E\u003C\u002Fscript\u003E";;return pug_html;};
module.exports = template;
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;pug_html = pug_html + "\u003Clink defer rel=\"stylesheet\" href=\"\u002Fcss\u002Ffaq.10535dc35837e1d0ad37.css\"\u003E";;return pug_html;};
module.exports = template;
...
pug_html = pug_html + "\u003Cdiv id=\"content-wrapper\"\u003E\u003Cdiv id=\"content\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-md-8\"\u003E\u003Ch2 class=\"mb-5 text-center\"\u003EBrowser\u003C\u002Fh2\u003E\u003Cdiv class=\"row my-5 pt-3\"\u003E\u003Cdiv class=\"col\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-10\"\u003E\u003Cdiv class=\"input-group input-group\"\u003E";
...
pug_mixins["question"].call({
block: function(){
pug_html = pug_html + "\u003Cp\u003EThis error is connected to the extensive usage of your GPU by multiple applications. Please make sure that you are running only one instance of the interactive map in your browser at the same time. You may also close any GPU dependent programs run locally on your computer and any other map-based web applications. Also, simple reloading the page often solves the issue.\u003Cbr\u003EFor more in-depth explanation, please visit this support \u003Ca href=\"https:\u002F\u002Fsupport.mozilla.org\u002Fen-US\u002Fquestions\u002F1334668\"\u003Epage\u003C\u002Fa\u003E.\u003C\u002Fp\u003E";
}
}, "question3", "Heatmaps are not visible. In the browser console there is a \"WebGL context was lost\" warning.");
pug_mixins["question"].call({
block: function(){
pug_html = pug_html + "\u003Cp\u003EThe cluster is created by grouping together any yet unassigned features which lay within given radius from the cluster center. The important thing to note is that distance determination happens on a globe, while the result is shown on a flat plane. The distances distortions that result from the sphere on the plane projection may in a consequence lead to misleading boundaries visualisation. \u003Cbr\u003EFor example, on the pictures below you can see two regions laying on the globe (left), and the same regions projected to the plane (right). The world coordinates of each vertex are exactly the same on both pictures.\u003Cimg class=\"my-4 d-block mx-auto\" src=\"\u002Fimg\u002Ffaq\u002Fdistortion_sm.jpg\"\u003ETo prevent such situations, you can use region clustering which is invariant on data and map view changes. You could also try to shuffle your dataset samples (source URL), which may change origin positions of the clusters to more favorable ones.\nIn the future, we will consider adding an option to change type of map projection and to visualize data on the globe, to further tackle this issue.\u003C\u002Fp\u003E";
}
...
pug_html = pug_html + (null == (pug_interp = (__webpack_require__(8785).call)(this, locals)) ? "" : pug_interp) + (null == (pug_interp = (__webpack_require__(6603).call)(this, locals)) ? "" : pug_interp) + (null == (pug_interp = (__webpack_require__(3678).call)(this, locals)) ? "" : pug_interp) + (null == (pug_interp = (__webpack_require__(802).call)(this, locals)) ? "" : pug_interp) + (null == (pug_interp = (__webpack_require__(1087).call)(this, locals)) ? "" : pug_interp) + (null == (pug_interp = (__webpack_require__(8635).call)(this, locals)) ? "" : pug_interp) + "\u003Cscript defer src=\"https:\u002F\u002Fcdnjs.cloudflare.com\u002Fajax\u002Flibs\u002FFlexSearch\u002F0.7.2\u002Fflexsearch.es5.js\" integrity=\"sha512-wz43ZAB8+0NQD7Yd+QC9afZaVxkC74GLPn0IzewyfExb88Cziu7fD6iUZYyjAMCT3n5mR\u002F80rB73tOJin4UKsw==\" crossorigin=\"anonymous\"\u003E\u003C\u002Fscript\u003E" + (null == (pug_interp = (__webpack_require__(727).call)(this, locals)) ? "" : pug_interp) + (null == (pug_interp = (__webpack_require__(2782).call)(this, locals)) ? "" : pug_interp) + "\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
        ...
        typeof dictionary !== 'undefined' ? dictionary : undefined, "isButtonPressed" in locals_for_with ?
...
;// CONCATENATED MODULE: ./views/pages/browser/css/style.scss
...
;// CONCATENATED MODULE: ./views/pages/browser/js/search.js
...
;// CONCATENATED MODULE: ./views/pages/browser/js/index.js
...
// EXTERNAL MODULE: ./views/pages/browser/index.pug
var browser = __webpack_require__(6816);
;// CONCATENATED MODULE: ./views/pages/browser/app.js
// Styles //
