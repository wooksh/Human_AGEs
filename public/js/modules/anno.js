...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Anno = Anno = (function() {
	  ...
	  Anno.prototype.hide = function() {
	    ...
	    $("#guide-button").removeAttr("disabled");
	    return this;
	  };
	  ...
	  Anno.prototype.annoElem = function() {
	    ...
	    this._annoElem.find('.anno-inner').append(this.optionsElem()).append(this.contentElem()).append(this.buttonsElem());
	  ...
	  Anno.prototype.optionsElem = function() {
	  	let $optionsContainer = $("<div class='anno-options'></div>");

	  	if(this.paging != undefined) {
	  		let $paging = $(`<i>${this.paging}</i>`);
	  		$optionsContainer.append($paging);
	  	}

	  	let $exitButt = $("<i class='anno-exit material-icons'>close</i>").click((function(_this) {
	      return function(evt) {
	        _this.hide();
	      };
	    })(this));

	  	$optionsContainer.append($exitButt);
	  ...
	  Anno.prototype.emphasiseTarget = function($target) {
	    ...
	    $target.addClass("anno-target-decoration");
	    this._undoEmphasise.push(function($t) {
	    	$t.removeClass("anno-target-decoration")
	    });
	  ...
	  Anno.prototype.positionAnnoElem = function(annoEl) {
	    ...
	    console.log(`ANNO positionAnnoElem ${pos}`);
	...
	exports.AnnoButton = AnnoButton = (function() {
	  ...
	  AnnoButton.prototype.buttonElem = function(anno) {
	    return $("<button class='btn custom-button no-focus mb-0'></button>").html(this.textFn(anno)).addClass(this.className).click((function(_this) {
	      return function(evt) {
