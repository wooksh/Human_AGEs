...
OPTIONAL MATCH (sample) -[:HAS]-> (admixtures:Admixture) -[:IS]-> (ad_results:ResultType)
    ...
    collect(admixtures.vector) as admixtures_values

OPTIONAL MATCH (this) -[:FROM_TIME]-> (dating:Dating) -[:IS]-> (dat_type:DatingType) 
    WITH this, sample, sample_origin, dating, dat_type, ad_results_names, admixtures_values

OPTIONAL MATCH (this) -[:IS]-> (sex:Sex)
    WITH this, sex, sample, sample_origin, dating, dat_type, ad_results_names, admixtures_values
OPTIONAL MATCH (this) -[:PART_OF]-> (pop:Population) 
    WITH this, sex, pop, sample, sample_origin, dating, dat_type, ad_results_names, admixtures_values
OPTIONAL MATCH (this) -[:HAS]-> (hy:HaplogroupY) 
    WITH this, sex, pop, hy, sample, sample_origin, dating, dat_type, ad_results_names, admixtures_values
OPTIONAL MATCH (this) -[:HAS]-> (hmt:HaplogroupMt) 
    WITH this, sex, pop, hy, hmt, sample, sample_origin, dating, dat_type, ad_results_names, admixtures_values
MATCH (use:UsePhase) <-[:FROM_TIME]- (this) -[:IN]-> (place:Place)
    WITH this, sex, pop, hy, hmt, sample, sample_origin, place, dating, dat_type, use, ad_results_names, admixtures_values

OPTIONAL MATCH (use) -[:IS]-> (use_fun:UsePhaseFunction)
    WITH this, sex, pop, hy, hmt, sample, sample_origin, place, dating, dat_type, use_fun, ad_results_names, admixtures_values

OPTIONAL MATCH (place) -[:IN]-> (reg_pols:PoliticalRegion) -[:IS]-> (div_pols:Division)
    WITH this, sex, pop, hy, hmt, sample, sample_origin, place, dating, dat_type, use_fun, reg_pols, ad_results_names, admixtures_values,
...
OPTIONAL MATCH (place) -[:IN]-> (reg_geos:GeographicalRegion) -[:IS]-> (div_geos:Division)
    WITH this, sex, pop, hy, hmt, sample, sample_origin, place, dating, dat_type, use_fun, reg_pols_names, div_pols_names, reg_geos, ad_results_names, admixtures_values,
    ...
    WITH this, sex, pop, hy, hmt, sample, sample_origin, place, dating, dat_type, use_fun, reg_pols_names, div_pols_names, ad_results_names, admixtures_values,
...
OPTIONAL MATCH (place) -[:IN]-> (reg_culs:CulturalRegion) -[:IS]-> (div_culs:Division)
    WITH this, sex, pop, hy, hmt, sample, sample_origin, place, dating, dat_type, use_fun, reg_pols_names, div_pols_names, reg_geos_names, div_geos_names, reg_culs, ad_results_names, admixtures_values,
    ...
    WITH this, sex, pop, hy, hmt, sample, sample_origin, place, dating, dat_type, use_fun, reg_pols_names, div_pols_names, reg_geos_names, div_geos_names, ad_results_names, admixtures_values,
...
WITH this, sex, pop, hy, hmt, place, sample, dating, dat_type, ad_results_names, admixtures_values,
...
RETURN {
    ...
    admixture_values: admixtures_values,
    admixture_types: ad_results_names,
    ...
    usephase_function: usephase_function,
